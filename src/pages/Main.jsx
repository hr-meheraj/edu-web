                        ...
                        <div class="row align-items-center g-5">
                            ...
                            <div class="col-lg-7 col-xl-6 text-center position-relative">
                                ...
                                <figure class="position-absolute bottom-0 start-50 translate-middle-x mt-4 mb-0">
                                    <svg width="550px" className='svg-pro' height="538px" viewBox="0 0 554 544" space="preserve">
                                ...
                                {/* <!-- Active student --> */}
                                <div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block mystyle">
                                    <p class="text-white">Our daily new students</p>
                                    {/* <!-- Avatar group --> */}
                                    <ul class="avatar-group mb-0">
                                        <li class="avatar avatar-sm">
                                            <img class="https://eduport.webestica.com/avatar-img rounded-circle border-white" src="https://eduport.webestica.com/assets/images/avatar/01.jpg" alt="avatar" />
                                        </li>
                                        <li class="avatar avatar-sm">
                                            <img class="https://eduport.webestica.com/avatar-img rounded-circle border-white" src="https://eduport.webestica.com/assets/images/avatar/02.jpg" alt="avatar" />
                                        </li>
                                        <li class="avatar avatar-sm">
                                            <img class="https://eduport.webestica.com/avatar-img rounded-circle border-white" src="https://eduport.webestica.com/assets/images/avatar/03.jpg" alt="avatar" />
                                        </li>
                                        <li class="avatar avatar-sm">
                                            <img class="https://eduport.webestica.com/avatar-img rounded-circle border-white" src="https://eduport.webestica.com/assets/images/avatar/04.jpg" alt="avatar" />
                                        </li>
                                        <li class="avatar avatar-sm">
                            ...
                            <div class="tab-pane fade" id="course-pills-tabs-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-6 col-lg-4 col-xl-3">
                                        <div class="card shadow h-100">
                                            {/* <!-- Image --> */}
                                            <img src="https://eduport.webestica.com/https://eduport.webestica.com/assets/images/courses/4by3/05.jpg" class="card-img-top" alt="course image" />
                                            <div class="card-body pb-0">
                                                {/* <!-- Badge and favorite --> */}
                                                <div class="d-flex justify-content-between mb-2">
                                                    <a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
                            ...
                            <div class="tab-pane fade" id="course-pills-tabs-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-6 col-lg-4 col-xl-3">
                                        <div class="card shadow h-100">
                                            {/* <!-- Image --> */}
                                            <img src="https://eduport.webestica.com/https://eduport.webestica.com/assets/images/courses/4by3/08.jpg" class="card-img-top" alt="course image" />
                                            <div class="card-body pb-0">
                                                {/* <!-- Badge and favorite --> */}
                                                <div class="d-flex justify-content-between mb-2">
                                                    <a href="#" class="badge bg-purple bg-opacity-10 text-purple">All level</a>
                                    ...
                                    <div class="col-sm-6 col-lg-4 col-xl-3">
                                        <div class="card shadow h-100">
                                            {/* <!-- Image --> */}
                                            <img src="https://eduport.webestica.com/https://eduport.webestica.com/assets/images/courses/4by3/04.jpg" class="card-img-top" alt="course image" />
                                            <div class="card-body pb-0">
                                                {/* <!-- Badge and favorite --> */}
                                                <div class="d-flex justify-content-between mb-2">
                                                    <a href="#" class="badge bg-purple bg-opacity-10 text-purple">All level</a>
                            ...
                            <div class="tab-pane fade" id="course-pills-tabs-4" role="tabpanel" aria-labelledby="course-pills-tab-4">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-6 col-lg-4 col-xl-3">
                                        <div class="card shadow h-100">
                                            {/* <!-- Image --> */}
                                            <img src="https://eduport.webestica.com/https://eduport.webestica.com/assets/images/courses/4by3/01.jpg" class="card-img-top" alt="course image" />
                                            <div class="card-body pb-0">
                                                {/* <!-- Badge and favorite --> */}
                                                <div class="d-flex justify-content-between mb-2">
                                                    <a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
                    ...
                    <div class="col-xl-7 order-2 order-xl-1">
                        ...
                        <div class="row mt-5 mt-xl-0">
                            ...
                            <div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                                ...
                                <div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center mystyle2">
                                    {/* <!-- Info --> */}
