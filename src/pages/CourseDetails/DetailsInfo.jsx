				...
				<div class="card shadow rounded-2 p-0">
					...
					<div class="card-header border-bottom px-4 py-3">
						<ul class="nav nav-pills nav-tabs-line py-0" id="course-pills-tab" role="tablist">
							...
							{/* <!-- Tab item --> */}
							<li class="nav-item me-2 me-sm-4" role="presentation">
								<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-4" data-bs-toggle="pill" data-bs-target="#course-pills-4" type="button" role="tab" aria-controls="course-pills-4" aria-selected="false" tabindex="-1">Reviews</button>
							</li>
							{/* <!-- Tab item --> */}
							<li class="nav-item me-2 me-sm-4" role="presentation">
								<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-5" data-bs-toggle="pill" data-bs-target="#course-pills-5" type="button" role="tab" aria-controls="course-pills-5" aria-selected="false" tabindex="-1">FAQs </button>
							</li>
							{/* <!-- Tab item --> */}
							<li class="nav-item me-2 me-sm-4" role="presentation">
								<button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-6" data-bs-toggle="pill" data-bs-target="#course-pills-6" type="button" role="tab" aria-controls="course-pills-6" aria-selected="true">Comment</button>
							</li>
						</ul>
					</div>
					{/* <!-- Tabs END --> */}
					...
					<div class="card-body p-4">
						<div class="tab-content pt-2" id="course-pills-tabContent">
							...
							<div class="tab-pane fade" id="course-pills-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
								...
								<div class="card mb-0 mb-md-4">
									<div class="row g-0 align-items-center">
										<div class="col-md-5">
											{/* <!-- Image --> */}
											<img src=" https://eduport.webestica.com/assets/images/instructor/01.jpg" class="img-fluid rounded-3" alt="instructor-image"/>
										</div>
										<div class="col-md-7">
											{/* <!-- Card body --> */}
											<div class="card-body">
							...
							<div class="tab-pane fade" id="course-pills-4" role="tabpanel" aria-labelledby="course-pills-tab-4">
								...
								<div class="row">
									...
									<div class="d-md-flex my-4">
										{/* <!-- Avatar --> */}
										<div class="avatar avatar-xl me-4 flex-shrink-0">
											<img class="avatar-img rounded-circle" src=" https://eduport.webestica.com/assets/images/avatar/07.jpg" alt="avatar"/>
										</div>
										{/* <!-- Text --> */}
										<div>
											<div class="d-sm-flex mt-1 mt-md-0 align-items-center">
								...
								<div class="mt-2">
									...
									<form class="row g-3">
										...
										<div class="col-md-6 bg-light-input">
											<input type="text" class="form-control" id="inputtext" placeholder="Name" aria-label="First name" spellcheck="false" data-ms-editor="true"/>
										</div>
										{/* <!-- Email --> */}
										<div class="col-md-6 bg-light-input">
										...
										<div class="col-12 bg-light-input">
											<div class="choices" data-type="select-one" tabindex="0" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false"><div class="choices__inner"><select id="inputState2" class="form-select js-choice choices__input" hidden="" tabindex="-1" data-choice="active"><option value="★★★★★ (5/5)" data-custom-properties="[object Object]">★★★★★ (5/5)</option></select><div class="choices__list choices__list--single"><div class="choices__item choices__item--selectable" data-item="" data-id="1" data-value="★★★★★ (5/5)" data-custom-properties="[object Object]" aria-selected="true">★★★★★ (5/5)</div></div></div><div class="choices__list choices__list--dropdown" aria-expanded="false"><input type="text" class="choices__input choices__input--cloned" autocomplete="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" aria-label="null" placeholder=""/><div class="choices__list" role="listbox"><div id="choices--inputState2-item-choice-1" class="choices__item choices__item--choice is-selected choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="★★★★★ (5/5)" data-select-text="Press to select" data-choice-selectable="" aria-selected="true">★★★★★ (5/5)</div><div id="choices--inputState2-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="★★★★☆ (4/5)" data-select-text="Press to select" data-choice-selectable="">★★★★☆ (4/5)</div><div id="choices--inputState2-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="★★★☆☆ (3/5)" data-select-text="Press to select" data-choice-selectable="">★★★☆☆ (3/5)</div><div id="choices--inputState2-item-choice-4" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="4" data-value="★★☆☆☆ (2/5)" data-select-text="Press to select" data-choice-selectable="">★★☆☆☆ (2/5)</div><div id="choices--inputState2-item-choice-5" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="5" data-value="★☆☆☆☆ (1/5)" data-select-text="Press to select" data-choice-selectable="">★☆☆☆☆ (1/5)</div></div></div></div>
										</div>
										{/* <!-- Message --> */}
										<div class="col-12 bg-light-input">
											<textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Your review" rows="3" spellcheck="false" data-ms-editor="true"></textarea>
										</div>
										{/* <!-- Button --> */}
										<div class="col-12">
							...
							{/* <!-- Content START --> */}
							<div class="tab-pane fade active show" id="course-pills-6" role="tabpanel" aria-labelledby="course-pills-tab-6">
								{/* <!-- Review START --> */}
								<div class="row">
									<div class="col-12">
										...
										<div class="d-flex mb-4">
											...
											<div class="avatar avatar-sm flex-shrink-0 me-2">
												<a href="#"> <img class="avatar-img rounded-circle" src=" https://eduport.webestica.com/assets/images/avatar/09.jpg" alt=""/> </a>
											</div>

											<form class="w-100 d-flex">
												<textarea class="one form-control pe-4 bg-light" id="autoheighttextarea" rows="1" placeholder="Add a comment..." spellcheck="false" data-ms-editor="true"></textarea>
												...
												<li class="comment-item">
													<div class="d-flex mb-3">
														...
														<div class="avatar avatar-sm flex-shrink-0">
															<a href="#"><img class="avatar-img rounded-circle" src=" https://eduport.webestica.com/assets/images/avatar/05.jpg" alt=""/></a>
														</div>
														<div class="ms-2">
															{/* <!-- Comment by --> */}
														...
														<li class="comment-item">
															<div class="d-flex">
																...
																<div class="avatar avatar-xs flex-shrink-0">
																	<a href="#"><img class="avatar-img rounded-circle" src=" https://eduport.webestica.com/assets/images/avatar/06.jpg" alt=""/></a>
																</div>
																{/* <!-- Comment by --> */}
																<div class="ms-2">
																	<div class="bg-light p-3 rounded">
											...
											<ul class="list-unstyled mb-0">
												<li class="comment-item">
													<div class="d-flex">
														{/* <!-- Avatar --> */}
														<div class="avatar avatar-sm flex-shrink-0">
															<a href="#"><img class="avatar-img rounded-circle" src=" https://eduport.webestica.com/assets/images/avatar/02.jpg" alt=""/></a>
														</div>
														<div class="ms-2">
															{/* <!-- Comment by --> */}
															<div class="bg-light p-3 rounded">
					...
					<div class="col-md-6 col-lg-12">
						...
						<div class="card shadow p-2 mb-4 z-index-9">
							<div class="overflow-hidden rounded-3">
								<img src=" https://eduport.webestica.com/assets/images/courses/4by3/01.jpg" class="card-img" alt="course image"/>
								{/* <!-- Overlay --> */}
					...
					<div class="col-md-6 col-lg-12">
						...
						<div class="card card-body shadow p-4 mb-4">
							...
							<div class="row gx-3 mb-3">
								<div class="col-4">
									<img class="rounded" src=" https://eduport.webestica.com/assets/images/courses/4by3/21.jpg" alt=""/>
								</div>
								<div class="col-8">
							...
							<div class="row gx-3">
								{/* <!-- Image --> */}
								<div class="col-4">
									<img class="rounded" src=" https://eduport.webestica.com/assets/images/courses/4by3/18.jpg" alt=""/>
								</div>
								<div class="col-8">
