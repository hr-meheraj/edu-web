		...
		<div className="container-fluid px-3 px-xl-5">
								...
								<div className="dropdown-menu dropdown-menu-start dropdown-width-lg" data-bs-popper="none">
									<div className="row p-4">
										...
										<div className="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
											...
											<div className="d-flex mb-4 position-relative">
												<img src="https://eduport.webestica.com/assets/images/client/uni-logo-01.svg" className="icon-md" alt=""/>
												<div className="ms-3">
											...
											{/* <!-- Dropdown item --> */}
											<div className="d-flex mb-4 position-relative">
												<img src="https://eduport.webestica.com/assets/images/client/uni-logo-02.svg" className="icon-md" alt=""/>
												<div className="ms-3">
											...
											{/* <!-- Dropdown item --> */}
											<div className="d-flex mb-4 position-relative">
												<img src="https://eduport.webestica.com/assets/images/client/uni-logo-03.svg" className="icon-md" alt=""/>
												<div className="ms-3">
											...
											<div className="d-flex position-relative">
												<img src="https://eduport.webestica.com/assets/images/client/uni-logo-04.svg" className="icon-md" alt=""/>
												<div className="ms-3">
									...
									<div className="row">
										<div className="col-12">
											<div className="card bg-blue rounded-0 rounded-bottom p-3 position-relative overflow-hidden" style={{
								...
								<div className="col-xl-6 col-xxl-3">
									...
									<div className="row g-2 justify-content-center mt-3">
										...
										<div className="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="https://eduport.webestica.com/assets/images/client/google-play.svg" className="btn-transition" alt="google-store"/> </a>
										</div>
										{/* <!-- App store button --> */}
										<div className="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="https://eduport.webestica.com/assets/images/client/app-store.svg" className="btn-transition" alt="app-store"/> </a>
										</div>
									</div>
								</div>
								...
								<div className="col-12">
									<div className="alert alert-success alert-dismissible fade show mt-2 mb-0 rounded-3" role="alert">
										...
										<div className="avatar avatar-xs me-2">
											<img className="avatar-img rounded-circle" src="https://eduport.webestica.com/assets/images/avatar/09.jpg" alt="avatar"/>
										</div>
										{/* <!-- Info --> */}
				...
				<div className="nav my-3 my-xl-0 px-4 flex-nowrap align-items-center">
					<div className="nav-item w-100">
						<form className="position-relative">
							<input className="form-control pe-5 bg-transparent" type="search" placeholder="Search" aria-label="Search" spellcheck="false" data-ms-editor="true"/>
			...
			<div className="dropdown ms-1 ms-lg-0">
				<a className="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
					<img className="avatar-img rounded-circle" src="https://eduport.webestica.com/assets/images/avatar/01.jpg" alt="avatar"/>
				</a>
					...
					<li className="px-3 mb-3">
						<div className="d-flex align-items-center">
							...
							<div className="avatar me-3">
								<img className="avatar-img rounded-circle shadow" src="https://eduport.webestica.com/assets/images/avatar/01.jpg" alt="avatar"/>
							</div>
							<div>
